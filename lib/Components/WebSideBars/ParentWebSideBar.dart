...
class ParentWebSideBar extends StatefulWidget {
  ...
  @override
  _ParentWebSideBarState createState() => _ParentWebSideBarState();
}

class _ParentWebSideBarState extends State<ParentWebSideBar> {
  bool studentsPressed = true;
